...
<head>
    ...
    <style>
        body {
            background: url('image1.jpg') no-repeat center center fixed; /* Update with your image path */
        ...
        .btn-success {
  background-color: #0047AB; /* Replace 'blue' with your preferred color */
  border-color: #0047AB;     /* Change border color to match */
}
